    ...
    <div class="form-container">
        ...
        <form class="form p-6">
            <div>
                ...
                <input v-model="ownerName" type="text" maxlength="249" name="ownerName" id="ownerName" class="" required> 
            </div>
            <div>
                <label for="printName">FATHER's NAME*</label><br>
                <input v-model="fatherName" type="text" maxlength="199" name="fatherName" id="fatherName" class="" required>
            </div>
            ...
            <div class="input-address">
                <div>
                    ...
                    <textarea v-model="address" type="text" id="address" name="address" maxlength="299" row="4" required></textarea>
                </div>                  
            </div>
            ...
            <div class="input-address">
                <div>
                    ...
                    <textarea v-model="addressT" type="text" id="addressT" name="addressT" maxlength="299" row="4"></textarea>
                </div>                  
            </div>

            <div class="vertical-center">
                <label for="mobileNo">MOBILE NO</label><br>
                <input v-model="mobileNo" type="text" name="mobileNo" id="mobileNo" maxlength="10" >
            </div>
            ...
            <div>
                <button class="submit-btn w-[80%]" @click.prevent="submitOwnerMasterEntry()">Submit</button>
            </div>
...
// <!-- ownerName varchar(250) primary key,
//     fatherName varchar(200) not null,
//     address varchar(300) not null,
//     addressT varchar(300),
//     phoneNo varchar(10),
//     panNo varchar(10),
//     tds bit(1) not null -->
